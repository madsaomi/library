...
urlpatterns = [
    ...
    path('textbooks/', views.textbook_loans, name='textbook_loans'),
    path('textbooks/distribute/', views.textbook_distribute, name='textbook_distribute'),
    path('textbooks/collect/', views.textbook_collect, name='textbook_collect'),
    ...
    path('import/students/', views.import_students_csv, name='import_students_csv'),
    path('import/books/', views.import_books_csv, name='import_books_csv'),
]
